...
async function createDesign() {
  ...
  await figma.loadFontAsync({ family: "Inter", style: "Regular" });
  text1.characters = "Sign in to continue";
  text1.fontSize = 15;
  text1.fills = [{
    type: 'SOLID',
    color: { r: 0, g: 0, b: 0 }
  ...
  await figma.loadFontAsync({ family: "Inter", style: "Regular" });
  text5.characters = "Forgot Password?";
  text5.fontSize = 13;
  text5.fills = [{
    type: 'SOLID',
    color: { r: 0, g: 0, b: 0 }
  ...
  await figma.loadFontAsync({ family: "Inter", style: "Regular" });
  text6.characters = "Don't have an account?";
  text6.fontSize = 17;
  text6.fills = [{
    type: 'SOLID',
    color: { r: 0, g: 0, b: 0 }
  ...
  frame8.resize(120, 44);
  frame8.x = 20;
  frame8.y = 480;
  frame.appendChild(frame8);
  ...
  frame10.resize(120, 44);
  frame10.x = 20;
  frame10.y = 600;
  frame.appendChild(frame10);

  const rect11 = figma.createRectangle();
  rect11.resize(100, 100);
  rect11.fills = [{
    type: 'SOLID',
    color: { r: 0.5, g: 0.5, b: 0.5 }
  }];
  rect11.cornerRadius = 0;
  rect11.x = 20;
  rect11.y = 660;
  frame.appendChild(rect11);

  const frame12 = figma.createFrame();
  frame12.resize(200, 200);
  frame12.x = 20;
  frame12.y = 720;
  frame.appendChild(frame12);

  const frame13 = figma.createFrame();
  frame13.resize(200, 200);
  frame13.x = 20;
  frame13.y = 780;
  frame.appendChild(frame13);

  const rect14 = figma.createRectangle();
  rect14.resize(100, 100);
  rect14.fills = [{
    type: 'SOLID',
    color: { r: 0.5, g: 0.5, b: 0.5 }
  }];
  rect14.cornerRadius = 10.0;
  rect14.x = 20;
  rect14.y = 840;
  frame.appendChild(rect14);

  const rect15 = figma.createRectangle();
  rect15.resize(100, 100);
  rect15.fills = [{
    type: 'SOLID',
    color: { r: 0.5, g: 0.5, b: 0.5 }
  }];
  rect15.cornerRadius = 10.0;
  rect15.x = 20;
  rect15.y = 900;
  frame.appendChild(rect15);
